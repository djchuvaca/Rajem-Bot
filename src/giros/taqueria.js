...
module.exports = {
  ...
  cortes: [
    ...
    { slug: 'carne',      nombre: 'Carne/Maciza', precio_base: 30, seccion: 'carnitas',
    ...
    { slug: 'surtido',    nombre: 'Surtido',      precio_base: 30, seccion: 'carnitas',
    ...
    { slug: 'surtido especial', nombre: 'Surtido Especial', precio_base: 30, seccion: 'carnitas',
